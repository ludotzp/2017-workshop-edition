...
var store = [{% for text in site.texts %}{
  ...
  "mode": {{text.mode | jsonify}}, 
  "excerpt": {{text.mode | append: text.content | strip_html | remove: "-"| remove: "[TOC] | "| replace: 'tc', '<b>Transcription</b>'| replace: 'tl', '<b>Translation</b>'| replace: 'tcn', '<b>Normalized Transcription</b>'| truncatewords: 20 | jsonify}}
}
