...
var store = [{% for text in site.texts %}{
  ...
  "mode": {{text.mode | jsonify}}, 
  "excerpt": {{text.mode + " " + text.content | strip_html |remove: "-"| remove: "[TOC] | "| replace: '[diplomatic]', '<b>Translation</b>'| replace: '[translation]', '<b>Diplomatic</b>'| truncatewords: 20 | jsonify}}
}
